...
$veeamserver = '172.0.0.136'   # Machine name where Veeam is installed
$SQLServer = '172.0.0.136\VEEAMSQL2016' # Database server where Veeam database is located. Change to sqlserver.contoso.local\InstanceName if you are running an SQL named instance
...
$SQLpwd = 'TecNet10'                   # SQL user password
...
function Get-RepoInfo() {
    ...
    $repoinfo = Get-CimInstance -Class Repository -ComputerName localhost -Namespace ROOT\VeeamBS
